 ...
 */
export declare function eqRegExp(x: RegExp, y: RegExp): boolean;
 ...
 * @public
 */
export declare function oncePerTick<T extends CallableFunction>(fn: T): T;
 ...
 * @public
 */
export declare function whenAvailable(childId: string, callback: (el: Element) => void, root?: Document | ShadowRoot): void;
